...
//	echo "no connection";
//}
$query="SELECT `Id`,`Image`, `Name`, `Price`,`Details` FROM `necklace` ORDER BY id ASC ";
...
if ($num>0) {
	while ($product1=mysqli_fetch_array($queryfire)) {
        ...
        <div class="card-body">
        	...
        	<img src="<?php echo
        	 $product1['Image'];?>" alt="Necklace" width="300px" height="250px">
            ...
            <button type="submit" class="view4"> <a href="nview.php?ab=<?php echo $product1['Image'] ?>">View</a></button>
...
$query1="SELECT `Id`,`Image`, `Name`, `Price`,`Details` FROM `necklace` WHERE Id=$id";
